...
public interface ObjectiveRepository extends JpaRepository<Objective,Long> {
    ...
    @Query(value = "select o from Objective o join Execute e on o.execute.id = e.id where e.project.id = :projectId and o.cycle.id = :cycleId and o.type = 1")
    List<Objective> findObjectivesByProjectIdAndCycleIdAndTypeProject(@Param(value = "projectId") long projectId,
